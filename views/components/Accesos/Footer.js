class Footer extends HTMLElement {
    ...
    connectedCallback() {
        ...
        .map(
          (link) =>
            `<li>
                  <a href="${link
                    .replace(/\s/g, "-")
                    .toLowerCase()}.html" class="text-sm hover:underline">${link}</a>
              </li>
            `
        )
        .join("\n");
     ...
     <footer class="bg-secondary-500 text-white">
        <div class="container flex flex-col p-4 mx-auto md:px-8 md:py-2 lg:flex-row">
  ...
  window.customElements.define("login-footer", Footer);
